...
export default class ActionExecutor implements ISink<ActionName> {
    ...
    actions: { [index: string]: Action | undefined } = {
        r: this.game.cube.faces.r.move.bind(null, true),
        r_rev: this.game.cube.faces.r.move.bind(null, false),
        l: this.game.cube.faces.l.move.bind(null, true),
        l_rev: this.game.cube.faces.l.move.bind(null, false),
        f: this.game.cube.faces.f.move.bind(null, true),
        f_rev: this.game.cube.faces.f.move.bind(null, false),
        b: this.game.cube.faces.b.move.bind(null, true),
        b_rev: this.game.cube.faces.b.move.bind(null, false),
        u: this.game.cube.faces.u.move.bind(null, true),
        u_rev: this.game.cube.faces.u.move.bind(null, false),
        d: this.game.cube.faces.d.move.bind(null, true),
        d_rev: this.game.cube.faces.d.move.bind(null, false),
